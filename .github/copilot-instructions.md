...
- Prefer controller-based API organization over Minimal APIs for long-term maintainability. Move backend endpoints into appropriate controllers to enhance clarity and structure.
